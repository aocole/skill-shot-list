...
ActiveRecord::Schema.define(version: 20181019191636) do
  ...
  add_index "localities", ["area_id"], name: "localities_area_id_idx", using: :btree
  ...
  create_table "machine_changes", force: :cascade do |t|
  ...
  add_index "machines", ["created_by_id"], name: "machines_creator_id_idx", using: :btree
  add_index "machines", ["location_id"], name: "machines_location_id_idx", using: :btree
  add_index "machines", ["title_id"], name: "machines_title_id_idx", using: :btree
  ...
  add_index "titles", ["ipdb_id"], name: "titles_ipdb_id_key", unique: true, using: :btree
  ...
  add_foreign_key "machines", "locations", name: "machines_location_id_fk", on_delete: :cascade
  add_foreign_key "machines", "titles", name: "machines_title_id_fk", on_delete: :cascade
  add_foreign_key "machines", "users", column: "created_by_id", name: "machines_creator_id_fk", on_delete: :nullify
  add_foreign_key "machines", "users", column: "deleted_by_id", name: "machines_deleted_by_id_fk", on_delete: :nullify
end
